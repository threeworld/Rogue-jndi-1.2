...
public class Config {
    ...
    @Parameter(names = {"-g", "--gadget"}, description = "Use the client gadget to bypass the high-version JDK , choose the gadget to use", order = 6)
    public static String payload = "CommonsCollections6";
    ...
    public static void applyCmdArgs(String[] args) {
        ...
        JCommander jc = JCommander.newBuilder()
                ...
                .build();
        jc.parse(args);
        jc.setProgramName("java -jar target/RogueJndi-1.2.jar");
